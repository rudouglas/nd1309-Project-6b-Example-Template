App = {
  ...
  handleButtonClick: async function (event) {
    ...
    switch (processId) {
      case 1:
        return await App.fertiliseItem(event);
        break;
      case 2:
        return await App.killItem(event);
        break;
      case 3:
  ...
  addRole: async function (event) {
    ...
    console.log("selectedRole", output);
    ...
    switch (output) {
      case "originFarmerID":
        ...
        try {
          result = await instance.addFarmer(App.originFarmerID, {
      ...
      case "distributorID":
        ...
        try {
          result = await instance.addDistributor(App.distributorID, {
            from: App.metamaskAccountID,
          });
          return result;
        } catch (err) {
      ...
      case "retailerID":
        ...
        try {
          result = await instance.addRetailer(App.retailerID, {
            from: App.metamaskAccountID,
          });
          return result;
        } catch (err) {
      ...
      case "consumerID":
        ...
        try {
          result = await instance.addConsumer(App.consumerID, {
            from: App.metamaskAccountID,
          });
          return result;
        } catch (err) {
  ...
  fertiliseItem: function (event) {
    event.preventDefault();
    var processId = parseInt($(event.target).data("id"));
    console.log({ processId, app: App.metamaskAccountID });
    App.contracts.SupplyChain.deployed()
      .then(function (instance) {
        return instance.fertiliseItem(App.upc, App.metamaskAccountID);
      })
      .then(function (result) {
        $("#ftc-item").text(result);
        console.log("fertiliseItem", result);
      })
      .catch(function (err) {
        console.log(err.message);
      });
  ...
  killItem: function (event) {
    event.preventDefault();
    var processId = parseInt($(event.target).data("id"));

    App.contracts.SupplyChain.deployed()
      .then(function (instance) {
        return instance.killItem(App.upc, App.productNotes);
      })
      .then(function (result) {
        $("#ftc-item").text(result);
        console.log("killItem", result);
      })
      .catch(function (err) {
        console.log(err.message);
      });
